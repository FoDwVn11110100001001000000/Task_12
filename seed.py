...
def fill_data():
    disciplines = ['Вища математика', 'Хімія', 'Економічна теорія', 'Фінанси та кредит', 'Історія України','Системне програмування']

    groups = ['ФФО1', 'МДА2', 'БА10']
    ...
    def seed_grades():
        ...
        end_date = datetime.strptime("2022-06-10", "%Y-%m-%d")
